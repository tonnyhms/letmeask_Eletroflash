...
export function Room(){
  ...
  async function handleLikeQuestion(questionId: string, likeId: string | undefined){
    if(likeId)  {
      const newLike = await banco.ref(`rooms/${roomId}/questions/${questionId}/likes/${likeId}`).remove();
    }else{
      const newLike = await banco.ref(`rooms/${roomId}/questions/${questionId}/likes`).push({
        authorId: user?.id,
